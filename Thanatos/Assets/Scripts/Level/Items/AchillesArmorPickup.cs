...
public class AchillesArmorPickup : MonoBehaviour, IPickupableAttire
{
    private string _name = "Armor of Achilles";
    ...
    public void Pickup()
    {
        if (LevelController.playerHasAchillesArmor) return;
        ...
        LevelController.playerHasAchillesArmor = true;
