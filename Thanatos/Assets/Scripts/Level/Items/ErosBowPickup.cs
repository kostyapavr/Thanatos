...
public class ErosBowPickup : MonoBehaviour, IPickupableWeapon
{
    [SerializeField]
    ...
    public virtual void Pickup()
    {
        ...
        LevelController.playerHasErosBow = true;
        CheckSwitch();
    ...
    private void Start()
    {
        //if (PlayerPrefs.GetInt("HasErosBow") == 0 && !SceneManager.GetActiveScene().name.Contains("Boss")) gameObject.SetActive(false);
    }
